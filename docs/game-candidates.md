...
| **Breakout / 벽돌깨기** | 패들 + 공 + 벽돌 격자 | ★★★ | **2026-07-28 done** → `games/brick-breaker/` · 파워업 6종 · 특수 벽돌 · 5스테이지 |
...
| 게임 | 메커닉 | 난이도 | 비고 |
|------|--------|-------|------|
| **리듬 게임 (Beat Tap)** | 떨어지는 음표 타이밍에 맞춰 누르기 | ★★★ | 음악 동기화 · 2026-07 시도 후 폐기 (재미 부족) |
| **타워 디펜스** | 경로에 타워 배치 → 적 웨이브 막기 | ★★★★★ | 가장 복잡, 경로/적/타워 클론 다수 |
| **공 튕기기 (Pong-like)** | 마우스로 패들 → 공 컨트롤 | ★ | 입문, 한국 자료 단골 |
| **Idle Clicker** | 클릭 + 업그레이드 | ★ | 단순하지만 중독성 |
| **수박 게임 (Suika)** | 과일 드롭·같은 종류 합체·수박까지 | ★★★ | **2026-07-28 폐기** — 원 물리 부하·격자 재미 부족 → 폴더 삭제. 교훈: [`lessons.md`](./lessons.md) |
...
7. **🟧 Tetris** (★★★★ / 액션·퍼즐)
8. **🛡 타워 디펜스** (★★★★★ / 액션·전략)
9. **🎵 리듬 게임** (★★★ / 음악·반응속도) — ❌ 폐기 (2026-07, 재미 부족)
