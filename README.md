...
| [다운웰](games/downwell/) | 액션 — 로그라이트 | 인디게임 Downwell 스타일 수직 슈팅. 우물 아래로 떨어지며 발 밑으로 총을 쏴 적을 처치하고(쏘면 잠깐 떠올라 체공), 적을 밟아 탄약을 충전합니다. 땅에 안 닿고 연속 처치하면 **콤보 곱 점수**! 깊이 갈수록 강화. **32개 한글 손잡이 + 코드 가이드 주석으로 뜯어볼 수 있습니다.** |
