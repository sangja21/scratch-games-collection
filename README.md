...
| [어항 포식자](games/fish-tank/) | 액션 — 성장 (피딩 프렌지형) | 방향키로 물고기를 조종해, 자유롭게 헤엄치는 다른 물고기 중 **나보다 작은 것(초록빛)만 골라 먹어** 점점 커집니다. 큰 것(붉은빛)에 닿으면 잡아먹혀 끝. 목표 크기에 도달하면 클리어. **14개 한글 손잡이(성장량·먹기기준·속도·스폰 등)로 코드를 바꾸며 놀 수 있습니다.** |
